...
export const PREANALYSIS_PROMPT_CONTRACT_VERSION = '1.0.0';
...
export const PREANALYSIS_UNCERTAINTY_CODES_V1 = [
...
export function buildPreanalysisPromptV1(): string {
...
{
  "version": "${PREANALYSIS_PROMPT_CONTRACT_VERSION}",
  "dictation": "<original>",
  "needsConfirmation": true|false,
  "intents": [
    {
      "intentId": "string",
      "treatmentId": "${toPipeList(PREANALYSIS_TREATMENT_IDS_V1)}",
      ...
      "uncertainty": "${toPipeList(PREANALYSIS_UNCERTAINTY_CODES_V1)} optional"
    }
  ]
}
Regeln:
