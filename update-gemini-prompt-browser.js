// Script to update the Gemini prompt for "Füllungstherapie" template
// Copy and paste this entire code into your browser console while on the Settings page
...
// Diese Funktion kann direkt in der Browser-Console ausgeführt werden
// Voraussetzung: Sie müssen auf der Settings-Seite sein und Firebase-Funktionen verfügbar haben

async function updateFuellungstherapieGeminiPrompt() {
  try {
    // Importiere Firebase-Funktionen (funktioniert nur wenn die App läuft)
    ...
    console.log('\n💡 Alternative: Kopieren Sie den Prompt manuell in das Textfeld in Settings.');
  }
}

// Exportiere für Browser-Console
if (typeof window !== 'undefined') {
  window.updateFuellungstherapieGeminiPrompt = updateFuellungstherapieGeminiPrompt;
  console.log('✅ Funktion geladen! Führen Sie aus: updateFuellungstherapieGeminiPrompt()');
}
