...
await caseService.finalizeCase(orgId, practiceId, caseId, {
    ...
    resolvedSettings: { ... },
    kbMeta: {
        releaseId: '2026-02-01',
        medical: { version: 'v1', hash: 'sha256:...', source: 'json' },
        treatments: {
            fuellung: { version: '2025-01-v2', hash: 'sha256:...', source: 'json' },
        },
        combinability: { version: 'v1', hash: 'sha256:...', source: 'json' },
    },
...
| `kbMeta` | KB versions + hashes (medical + treatment + combinability + releaseId) |
